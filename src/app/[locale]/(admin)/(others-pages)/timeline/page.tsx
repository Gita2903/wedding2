...
export default function TimelinePage() {
  ...
  // Auto-generate if empty — guarded so it only fires once per mount
  // to prevent an infinite loop when the regenerate call updates data
  // (which re-triggers this effect) but tasks are still loading.
  useEffect(() => {
